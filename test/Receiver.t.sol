...
contract ReceiverTest is Test {
    ...
    function test_verifyBroadcastMessage_from_Ethereum_into_Arbitrum() public {
        ...
        accountProofList[0] = Lib_RLPWriter.writeBytes(
        ...
        accountProofList[1] = Lib_RLPWriter.writeBytes(
        ...
        accountProofList[2] = Lib_RLPWriter.writeBytes(
        ...
        accountProofList[3] = Lib_RLPWriter.writeBytes(
        ...
        accountProofList[4] = Lib_RLPWriter.writeBytes(
        ...
        accountProofList[5] = Lib_RLPWriter.writeBytes(
        ...
        accountProofList[6] = Lib_RLPWriter.writeBytes(
        ...
        accountProofList[7] = Lib_RLPWriter.writeBytes(
        ...
        bytes memory accountProof = Lib_RLPWriter.writeList(accountProofList);
        ...
        storageProofList[0] = Lib_RLPWriter.writeBytes(
            hex"e8a120e9c5cc9c750ef3a170b3a02cf938ffded668959e8c4d274ee43f58103248e67e858468fa57d8"
        );

        bytes memory storageProof = Lib_RLPWriter.writeList(storageProofList);
        ...
        IReceiver.RemoteReadArgs memory remoteReadArgs = IReceiver.RemoteReadArgs({
            route: route,
            bhpInputs: bhpInputs,
            storageProof: storageProofToLastProver
        });
