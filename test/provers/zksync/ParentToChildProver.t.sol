...
contract ZkSyncParentToChildProverTest is Test {
    ...
    function setUp() public {
        ...
        uint256 latestBatchNumber = abi.decode(abi.encodePacked(new bytes(32 - latestBatch.length), latestBatch), (uint256));
        ...
        string memory params = string(abi.encodePacked("[\"", vm.toString(account), "\",[\"", vm.toString(storageKeys[0]), "\"],", vm.toString(latestBatchNumber - 150), "]"));
