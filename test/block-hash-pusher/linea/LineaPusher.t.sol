...
contract LineaPusherTest is Test {
    ...
    function test_pushHashes_fork() public {
        ...
        lineaPusher.pushHashes{value: 0.005 ether}(1, l2TransactionData);

        lineaPusher.pushHashes{value: 0.005 ether}(10, l2TransactionData);

        lineaPusher.pushHashes{value: 0.005 ether}(15, l2TransactionData);
        ...
        lineaPusher.pushHashes{value: 0.004 ether}(1, l2TransactionData);
    }
    ...
    function testFuzz_pushHashes(uint16 batchSize) public {
        ...
        vm.prank(user);
        lineaPusher.pushHashes{value: 0.005 ether}(batchSize, l2TransactionData);
    }
    ...
    function testFuzz_pushHashes_reverts_if_value_too_low(uint16 batchSize) public {
        ...
        vm.prank(user);
        vm.expectRevert(abi.encodeWithSelector(IMessageService.ValueSentTooLow.selector));
        lineaPusher.pushHashes{value: 0.001 ether}(batchSize, l2TransactionData);
    }
    ...
    function testFuzz_pushHashes_invalidBatchSize(uint16 batchSize) public {
        ...
        lineaPusher.pushHashes(batchSize, l2TransactionData);
    }
