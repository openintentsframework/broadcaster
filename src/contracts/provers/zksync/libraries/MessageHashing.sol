...
library MessageHashing {
    ...
    error UnsupportedProofMetadataVersion(uint256 version);
    ...
    function parseProofMetadata(bytes32[] memory _proof) internal pure returns (ProofMetadata memory result) {
