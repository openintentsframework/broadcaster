...
import {
    ChildToParentProver as TaikoChildToParentProver
} from "../../src/contracts/provers/taiko/ChildToParentProver.sol";
...
contract DeployL2Prover is Script {
    function run() public {
        ...
        TaikoChildToParentProver childToParentProver =
            new TaikoChildToParentProver(signalServiceL2, checkpointsSlot, homeChainId);
        ...
        console.log("L2ProverPointer:", address(stateProverPointer));
    }
}
